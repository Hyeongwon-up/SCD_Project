...
public class CollectChanges {
	...
	public static String[] projects = { "lang", "ivy", "math", "collections", "derby", "hbase", "hadoop" };
	public static String baseDir = "/Users/ihyeong-won/Desktop/data";
	...
	public static void main(String[] args) {
		...
		try {
			...
			PreparedStatement psIns = con.prepareStatement(
					"insert into changes_ver3 ( fileId, tool, change_type, entity_type, edit, line) values ( ?, ?, ?, ?, ?, ?)");
